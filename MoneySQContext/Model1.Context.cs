...
namespace MoneySQContext
{
    ...
    {
        public MoneySQEntities()
            : base("name=MoneySQEntities")
        {
        }
        ...
        public virtual DbSet<ZZ_LAND_OWNERSHIP_CERTIFICATE_OTHER_RIGHTS> ZZ_LAND_OWNERSHIP_CERTIFICATE_OTHER_RIGHTS { get; set; }
