...
public class ZZ_APPLICATION
{
    ...
    public virtual DateTime? kyc_extracted_date { get; set; }
    public virtual short? kyc_extracted_batch_no { get; set; }
    public virtual short? kyc_extracted_empolyee_no { get; set; }
    public virtual DateTime? kyc_extracted_datetime { get; set; }
    [MaxLength(3)]
    public virtual string kyc_result_cd { get; set; }
    public virtual short? kyc_result_imported_empolyee_no { get; set; }
    public virtual DateTime? kyc_result_imported_datetime { get; set; }
    [MaxLength(100)]
    [Required]
